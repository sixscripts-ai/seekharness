...
description: >
  Probe boundaries where untrusted input may be interpreted as SQL, shell commands, templates, paths, expressions, or executable code. Use this skill when diagnosing security/injection or when seeing signals: sql injection, command injection, template injection, shell injection, parser injection, untrusted input.
license: MIT
...
Probe boundaries where untrusted input may be interpreted as SQL, shell commands, templates, paths, expressions, or executable code.

- **Primary Index**: `security/injection`
- **Context Cost**: `large`
...
2. **Formulate Hypotheses**:
   - Match symptoms against domain patterns for `security/injection`.
