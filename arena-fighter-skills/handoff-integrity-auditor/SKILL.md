...
description: >
  Analyze provenance, completeness, trust, mutability, and assumptions across explicit artifact or phase handoff boundaries. Use this skill when diagnosing artifacts/handoffs or when seeing signals: handoff integrity, artifact provenance, phase boundary, handoff, snapshot, provenance.
license: MIT
...
Analyze provenance, completeness, trust, mutability, and assumptions across explicit artifact or phase handoff boundaries.

- **Primary Index**: `artifacts/handoffs`
- **Context Cost**: `medium`
- **Applicable Roles**: `builder, breaker`
...
2. **Formulate Hypotheses**:
   - Match symptoms against domain patterns for `artifacts/handoffs`.
