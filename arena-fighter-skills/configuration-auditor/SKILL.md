...
description: >
  Trace configuration values through definitions, defaults, environment variables, files, arguments, overrides, and runtime consumers. Use this skill when diagnosing investigation/configuration or when seeing signals: configuration precedence, environment override, settings source, config, defaults, environment.
license: MIT
...
Trace configuration values through definitions, defaults, environment variables, files, arguments, overrides, and runtime consumers.

- **Primary Index**: `investigation/configuration`
- **Context Cost**: `medium`
...
2. **Formulate Hypotheses**:
   - Match symptoms against domain patterns for `investigation/configuration`.
