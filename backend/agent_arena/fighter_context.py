...
def fighter_tool_grammar() -> str:
    ...
    return (
        ...
        "TOOL clean path=... | TOOL run path=... | TOOL shell cmd='...' | "
        "TOOL install cmd='...' | TOOL grep pattern=... [path=...] | TOOL tree [path=...] | "
        "TOOL cp from=... to=... | TOOL mv from=... to=... | TOOL rm path=... | "
        "TOOL fetch url=... | TOOL search query=... | TOOL bg name=... content=... | "
        "TOOL ps | TOOL kill name=... | TOOL logs name=... | "
        "TOOL skills [index=...] [search=...] [skill=...] | TOOL use_skill name=... | "
        "TOOL playwright_navigate url=... | TOOL playwright_click selector=... | "
        "TOOL playwright_fill selector=... text=... | TOOL playwright_screenshot path=... | "
        "TOOL playwright_read selector=... | TOOL playwright_wait selector=... [timeout_ms=...] | "
        "TOOL http_request method=... url=... [headers=...] [body=...] | "
        "TOOL sql_query query=... | TOOL test [path=...] | DONE"
    )
