...
COLLECTIONS = {
    ...
    "battles": [
        ...
        ("draft_id", "string", False),
        ("battle_config", "string", False),
        ("spec_hash", "string", False),
        ("custom_title", "string", False),
    ...
    "battle_drafts": [
        ...
        ("status", "string", True),
        ("launched_battle_id", "string", False),
        ("architect_error", "string", False),
