---
name: frontend-state-debugger
description: >
  Trace client-side state, rendering, events, derived data, asynchronous updates, and API synchronization through a frontend application. Use this skill when diagnosing interface/frontend or when seeing signals: frontend state, render loop, stale UI state, react, event, rendering, client state.
license: MIT
...
Trace client-side state, rendering, events, derived data, asynchronous updates, and API synchronization through a frontend application.

- **Primary Index**: `interface/frontend`
- **Context Cost**: `medium`
...
2. **Formulate Hypotheses**:
   - Match symptoms against domain patterns for `interface/frontend`.
